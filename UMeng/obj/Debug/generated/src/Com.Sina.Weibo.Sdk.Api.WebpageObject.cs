...
namespace Com.Sina.Weibo.Sdk.Api {
	...
	public partial class WebpageObject : global::Com.Sina.Weibo.Sdk.Api.BaseMediaObject {
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/sina/weibo/sdk/api/WebpageObject", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (WebpageObject); }
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (WebpageObject)) {
					SetHandle (
		...
		public unsafe WebpageObject (global::Android.OS.Parcel p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.sina.weibo.sdk.api']/class[@name='WebpageObject']/method[@name='toExtraMediaObject' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.sina.weibo.sdk.api']/class[@name='WebpageObject']/method[@name='toExtraMediaString' and count(parameter)=0]"
