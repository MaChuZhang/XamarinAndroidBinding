	...
	internal partial class BaseMemoryCacheInvoker : BaseMemoryCache {
		...
		protected override unsafe global::Java.Lang.Ref.Reference CreateReference (global::Android.Graphics.Bitmap p0)
		{
			...
			try {
				...
				global::Java.Lang.Ref.Reference __ret = global::Java.Lang.Object.GetObject<global::Java.Lang.Ref.Reference> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_createReference_Landroid_graphics_Bitmap_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
