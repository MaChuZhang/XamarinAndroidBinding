			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (ImageViewAware)) {
					...
					global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Landroid/widget/ImageView;)V", __args);
					return;
				}
				...
				SetHandle (
						...
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_Landroid_widget_ImageView_, __args);
			} finally {
			}
		}
		...
		protected override unsafe void SetImageBitmapInto (global::Android.Graphics.Bitmap p0, global::Android.Views.View p1)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setImageBitmapInto", "(Landroid/graphics/Bitmap;Landroid/view/View;)V"), __args);
			} finally {
			}
		}
