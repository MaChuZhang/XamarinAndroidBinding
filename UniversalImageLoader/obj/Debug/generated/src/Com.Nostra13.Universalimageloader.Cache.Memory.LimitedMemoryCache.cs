			...
			get {
				...
				try {
					...
					if (GetType () == ThresholdType)
						return JNIEnv.CallIntMethod (((global::Java.Lang.Object) this).Handle, id_getSizeLimit);
					else
						return JNIEnv.CallNonvirtualIntMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getSizeLimit", "()I"));
				} finally {
				}
			}
		}
	...
	internal partial class LimitedMemoryCacheInvoker : LimitedMemoryCache {
		...
		protected override unsafe int GetSize (global::Android.Graphics.Bitmap p0)
		{
			...
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				int __ret = JNIEnv.CallIntMethod (((global::Java.Lang.Object) this).Handle, id_getSize_Landroid_graphics_Bitmap_, __args);
				return __ret;
			} finally {
			}
		}
